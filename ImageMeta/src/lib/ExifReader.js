  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).ExifReader = (function() {
    ...
    */
    ...
    ExifReader.prototype._read0thIfd = function() {
      ...
      return this._readIfd('0th IFD', ifdOffset);
    };
    ...
    ExifReader.prototype._readExifIfd = function() {
      ...
      if (this._tags['0th IFD']['Exif IFD Pointer'] != null) {
        ifdOffset = this._tiffHeaderOffset + this._tags['0th IFD']['Exif IFD Pointer'].value;
        this.deleteTag('0th IFD','Exif IFD Pointer');
        return this._readIfd('Exif IFD', ifdOffset);
      }
    };
    ...
    ExifReader.prototype._readGpsIfd = function() {
      ...
      if (this._tags['0th IFD']['GPS Info IFD Pointer'] != null) {
        ifdOffset = this._tiffHeaderOffset + this._tags['0th IFD']['GPS Info IFD Pointer'].value;
        this.deleteTag('0th IFD','GPS Info IFD Pointer');
        return this._readIfd('GPS IFD', ifdOffset);
      }
    };
    ...
    ExifReader.prototype._readInteroperabilityIfd = function() {
      ...
      if (this._tags['0th IFD']['Interoperability IFD Pointer'] != null) {
        ifdOffset = this._tiffHeaderOffset + this._tags['0th IFD']['Interoperability IFD Pointer'].value;
        this.deleteTag('0th IFD','Interoperability IFD Pointer');
        return this._readIfd('Interoperability IFD', ifdOffset);
      }
    };

    ExifReader.prototype._readIfd = function(ifdType, offset) {
      var fieldIndex, numberOfFields, tag, _i, _results;
      this._tags[ifdType] = this._tags[ifdType] || {};
      ...
      'GPS IFD': {
        ...
        0x001b: {
          ...
          'description': function(value) {
            ...
            var value = value.slice(0, 8).map(function(charCode) {
                return String.fromCharCode(charCode);
            }).join('');
            switch (value) {
                case 'ASCII\x00\x00\x00':
    ...
    */
    ...
    ExifReader.prototype.deleteTag = function(ifdType, name) {
      return delete this._tags[ifdType][name];
    };
